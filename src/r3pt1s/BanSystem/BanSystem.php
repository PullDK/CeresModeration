...
use  r3pt1s\BanSystem\command\muter3pt1s\BanSystem\command\warn\WarnCommand ;
...
class BanSystem extends PluginBase {
    ...
    const NO_PERMS = "§cVocê não tem permissão!";
    ...
    protected function onEnable(): void {
        ...
        $this->getLogger()->info(self::getPrefix() . "§aCarregado!");
        $this->getLogger()->info(self::getPrefix() . "§7Versâo: §e" . $this->getDescription()->getVersion());
        ...
        $this->getLogger()->info(self::getPrefix() . "§7CHECANDO ATUALIZAÇÕES...");
